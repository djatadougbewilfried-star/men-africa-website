      ...
      <section className="py-20 bg-[#1B2B5A]">
        <div className="container-premium text-center text-white">
          <h1 className="font-playfair text-4xl md:text-5xl font-bold mb-4">
            Mentions <span className="text-[#B8923B]">Légales</span>
          </h1>
        </div>
      </section>
        ...
        <div className="container-premium max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="text-gray-600 mb-8 space-y-2">
              ...
              <li><strong>Téléphones :</strong> (+225) 27 24 33 64 04 / 07 02 02 01 45</li>
            ...
            <p className="text-gray-600 mb-4">
              ...
              à caractère personnel en Côte d&apos;Ivoire, vous disposez d&apos;un droit d&apos;accès, de 
            ...
            <p className="text-gray-600 mb-8">
              ...
              le trafic. En poursuivant votre navigation, vous acceptez l&apos;utilisation de cookies.
            </p>
            ...
            <p className="text-gray-600 mb-8">
              ...
              ce site. Toutefois, elle ne saurait être tenue responsable des erreurs, omissions ou 
